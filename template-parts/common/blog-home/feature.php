<?php $pholosophy_fp = new WP_Query(array(
...
while($pholosophy_fp -> have_posts() ){
    $pholosophy_fp -> the_post();
    ...
    $post_data[] = array(
        ...
        "authour"   => get_the_author_meta("display_name"),

        "author_avator" => get_avatar_url(get_the_author_meta("ID")),
        "cat"           => $categories[mt_rand(0, count($categories))] -> name


    );
}
if($pholosophy_fp -> post_count > 1): ?>
                            ...
                            <div class="entry__content">
                                ...
                                <div class="entry__info">
                                    ...
                                    <ul class="entry__meta">
                                        <li><a href="#0"><?php echo esc_html($post_data[0]["authour"]);  ?></a></li>
                        ...
                        <div class="entry" style="background-image:url('<?php echo esc_url( $post_data[$i]["thumbnail"]) ?>'); ">
                            ...
                            <div class="entry__content">
                                ...
                                <div class="entry__info">
                                    ...
                                    <ul class="entry__meta">
                                        <li><a href="#0"><?php echo esc_html($post_data[$i]["authour"]);  ?></a></li>
